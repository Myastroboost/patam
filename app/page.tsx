...
import Optin from './components/Form/Optin'
//@ts-ignore
function Home() {
    ...
    const [chartAnimState, setChartAnim] =
    ...
    const getSOLPriceChange = async () => {
        ...
        if (Object.keys(_tData).length)
            if (priceChangeRef.current) {
                priceChangeRef.current.innerHTML =
                    _tData.priceChange.h6
    ...
    const scrollEvent = (e: any) => {
        ...
        if (
            Number(position) > 2700 &&
            Number(window.innerWidth) > 1000 &&
            chartFlag === false
        ) {
            chartFlag = true
            setChartAnim(true)
    ...
    useEffect(() => {
        ...
        socket.onopen = () => {
            socket.send(
                `{"op":"subscribe","args":[{"channel":"tickers","instId":"SOL-USDC"},{"channel":"cup-tickers-3s","ccy":"USDC"},{"channel":"mark-price","instId":"SOL-USDC"},{"channel":"index-tickers","instId":"SOL-USD"}]}`
            )
        }
    ...
    return (
        <div className="font-bold min-h-screen pb-[50px] sm:pb-[240px] min-[2000px]:max-w-[1920px] ">
            ...
            <Fade bottom>
                ...
                >
                    ...
                    <Fade right>
                        <div className="magaa flex flex-col items-center justify-center z-50 gap-y-[36px] absolute right-[5%] sm:right-[15%] md:right-2 lg:right-[100px] 2xl:right-[280px] bottom-[40px] md:top-[170px] w-[70%]  xl:w-[500px] 2xl:w-[740px]">
                            <img src="/assets/images/about-text.png" />
                            <div className="flex flex-row justify-between z-50 relative gap-x-[10px] sm:gap-x-[20px] lg:gap-x-[28px]  ">
            ...
            <section
                id="about"
                className="about relative min-h-[923px] flex items-start mt-[106px] sm:mt-[144px] pl-[20px] md:pl-[100px] xl:pl-[240px] overflow-hidden"
            >
                <Fade right>
                    <img
                        src="/assets/images/bg-about.png"
                        className="absolute hidden sm:block -right-[70%] md:-right-[40%] lg:right-0 top-[111px] max-w-[1440px] max-h-[785px] object-contain bg-no-repeat -z-10"
                        alt=""
                    />
                    <img
                        src="/assets/images/bg-about-sm.png"
                        className="absolute block sm:hidden right-0 top-[111px] w-[100% ] max-h-[785px] object-cover bg-no-repeat -z-10"
                        alt=""
                    />
                </Fade>
                <Fade bottom>
                    <div className="pr-[20px] pt-2 sm:pt-0">
                        ...
                        <div className="max-w-[482px] mt-[30px] sm:mt-[41px]">
                            <h1 className="text-[34px] leading-[44px] font-[700] tracking-tighter text-[#E23F49] pr-3">
                            ...
                            <div className="font-[500] text-[#C2C2C4] gap-y-[30px] flex flex-col text-[15px] leading-[30px] tracking-tighter mt-[59px]">
                                <p>
                                    Tired of delusional
                                    narcissists trying to take
                                    away your guns and freedom
                                    of speech?
                                </p>
                                <p>
                                    Want to keep drag queens out
                                    of your local library?
                                </p>
                                <p>
                                    Find it odd that selling
                                    nudes online is the new
                                    feminism?{' '}
                                </p>
                                <p>
                                    Do you miss the days where
                                    there were only 2 genders?{' '}
                                </p>
                                <p>
                                    Then say it with your chest
                                    and don't mix words; help us{' '}
                                    <span className="font-[700]">
                                        Make America Great
                                        Again, Again.
                                    </span>
                                    A percentage of trading
                                    volume is pooled to fund
            ...
            <section
                id="tokenomics"
                className="min-height-[900px]"
                onScroll={scrollEvent}
            >
                <Fade bottom>
                    <div className="pr-[50px] 2xl:pr-[258px] pl-[20px]">
                        <Heading
                            headingBottom="Tokenomics"
                            headingTop="MAGAA"
                        />
                    </div>
                </Fade>

                <div className="flex token flex-row items-center justify-between">
                    <div className="flex flex-col items-start w-full">
                        <div className="w-full flex items-center sm:flex-col xl:flex-row">
                            <Fade left>
                                <img
                                    className="w-full"
                                    src="/assets/images/token-img-1.png"
                                    alt=""
                                />
                            </Fade>
                            <div className="w-full sm:mt-10">
                                <h1 className="font-american-x text-white text-center sm:text-3xl xl:text-5xl">
                                    LAUNCHING SOON
                                </h1>
                            </div>
                        </div>
                        <Fade top>
                            <div className="ml-10 sm:ml-20 xl:ml-44 text-[26px] leading-[30px] pl-[24px] sm:pl-0 mt-[44px] font-[700] flex gap-y-[21px] flex-col tracking-tighter text-[#EEEEEE]">
                                <div className="inline-flex items-center gap-x-[10px]">
                                    <FaCircle className="text-[10px] text-[#E23F49]" />
                                    <p>
                                        <span className="text-[#E23F49]">
                                            1 billion{' '}
                                        </span>
                                        $MAGAA
                                    </p>
            ...
            <section
                id="chart"
                className="pl-[20px] sm:pl-[100px] xl:pl-[236px] flex flex-col items-start   mt-[100px] sm:mt-[195px] pr-[20px] 2xl:pr-0"
            >
                <Fade bottom>
                    <div>
                        <Heading
                            headingTop="DEXT"
                            headingBottom="DEXtools"
                        />
                    </div>
                </Fade>
                <Fade bottom>
                    <div className="flex flex-col 2xl:flex-row 2xl:items-end min-h-[117px] mb-[59px] mt-[24px] 2xl:mt-0">
                        <h1
                            ...
                            className="gradient-text text-[54px] font-american-x sm:text-[100px] leading-[86px] sm:leading-[116px] font-[400]"
                        >
                            <span className="text-[50px] font-american-x leading-[58px]">
                                $
                            </span>
                            <span ref={priceRef}></span>
                            {/* {
                flag ? <PriceCountUp price={price} />:<span ref={priceRef}></span>
              } */}
                        </h1>
                        {/* <Fade bottom> */}
                        <Fade bottom duration={1000}>
                            <div className="pb-[18px] ml-[11px]">
                                {!priceLoadingState ? (
                                    <span className="text-[#E23F49] text-[14px] leading-[20px] font-[400] inline-flex items-center">
                                    ...
                                    <span className="text-[#5D99FF] text-[14px] leading-[20px] font-[400] inline-flex items-center">
                                ...
                                <h2 className="text-[#EEEEEE] text-[20px] leading-[30px] tracking-tighter font-[500]">
                                    SOL/USDC
                                </h2>
                            </div>
                        </Fade>
                        ...
                        <div className="flex sm:flex-row items-end gap-x-[10px] 2xl:ml-[68px] pb-[18px]">
                            <Fade bottom duration={1300}>
                                <button
                                    ...
                                    className={` border-[1.5px] ${
                                        graphToggler == '10'
                                            ? 'radial-button-bg border-[#EE703A]'
                                            : 'bg-transparent border-[#75849D]'
                                    } rounded-[24px] h-[40px] px-[12px] sm:px-[15px]`}
                                >
                                ...
                                <button
                                    ...
                                    className={` border-[1.5px] ${
                                        graphToggler == '1'
                                            ? 'radial-button-bg border-[#EE703A]'
                                            : 'bg-transparent border-[#75849D]'
                                    } rounded-[24px] h-[40px] px-[12px] sm:px-[15px] mr-[17px] sm:mr-[76px]`}
                                >
                            ...
                            <Fade bottom duration={2100}>
                                <button
                                    ...
                                    className={`  ${
                                        timeToggler == 'D'
                                            ? 'radial-button-bg-time border-[#6CA3FF] text-[#EEEEEE]'
                                            : 'bg-transparent border-[#75849D] text-[#75849D]'
                                    }
