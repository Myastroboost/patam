        ...
        <>
            <div className='relative px-[40px] lg:px-[90px] xl:px-[150px] 2xl:px-[240px] h-[218px] hidden md:flex gap-x-[30px] lg:gap-x-[40px]
              ...
              leading-[20px] font-semibold'>
                ...
                <Link to="tokenomics" spy={true} smooth={true} className='hover-effect'>Tokenomics</Link>
                <Link to="chart" spy={true} smooth={true} className='hover-effect'>Chart</Link>
            ...
            <div className='relative px-[20px] h-[98px] flex md:hidden  flex-row items-start pt-[37px] justify-between text-[#E2EBFB] text-[24px]
             tracking-tighter leading-[20px] font-semibold'>
                ...
                <a href="/">
                    <img src="/assets/images/nav-logo-mobile.png" className='relative bottom-[12px]' alt="Not there" />
                </a>
                <div className='flex flex-row gap-x-[10px]'>
                    <a href="https://x.com/MAGAAtoken">
                        <BsTwitterX />
                    </a>
                    <a href="https://t.me/MAGAAtoken">
                        <FaTelegramPlane />
                    </a>
                </div>
            </div>
            ...
            <div
                style={{zIndex:9999}}
                className={`fixed  top-0 ${isSideBarOpened ? 'left-0' : '-left-[100%]'} text-[#d0def7] text-[17px] bg-[#2e355f] w-full h-full
                 transition-all duration-500 flex flex-col items-center justify-start pt-[100px] gap-y-[20px]`}
            >
                <img src="/assets/images/nav-logo-mobile.png" alt="Not there" />
